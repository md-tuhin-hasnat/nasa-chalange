import{t as e}from"./shaderStore-D-XQlhUT.js";var t=`oitDeclaration`,n=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=n);var r={name:t,shader:n},i=`decalFragmentDeclaration`,a=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=a);var o={name:i,shader:a},s=`textureRepetitionFunctions`,c=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=c);var l={name:s,shader:c},u=`depthPrePass`,d=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=d);var f={name:u,shader:d},p=`oitFragment`,m=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
